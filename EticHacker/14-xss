...
- dvwa > xss stored // Forma girilen bilgileri veritabanına kaydeder. Tarayıcı yenilense bile girilen form ekranda gösterildiği için zararlı js kodu eklenirse siteye giren tüm kullanıcılar hacklenir
